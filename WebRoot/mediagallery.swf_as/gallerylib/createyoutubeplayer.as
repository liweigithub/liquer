package gallerylib 
{
    ...
    {
        public function createyoutubeplayer(arg1:flash.display.Stage, arg2:flash.display.MovieClip, arg3:flash.display.MovieClip, arg4:flash.display.MovieClip, arg5:flash.display.MovieClip, arg6:Object, arg7:String, arg8:String, arg9:Number, arg10:Number, arg11:String, arg12:String, arg13:Number)
        {
        ...
        internal function fsOff():void
        {
            ...
            this.previewimage.width = loc1 = this._widthvar;
            this.playermask.width = loc1;
            this.previewimage.height = loc1 = this._heightvar;
        ...
        internal function fsOn():void
        {
            ...
            this.mc_hd.x = -this.playercontainer.x + this._root.videovolumewidth + this._root.videobuttonsize + this._root.videobuttonspacing * 3 + this._root.videobuttonborderspacing + this.seekbarwidthfs - this._root.playerx - this._root.gallerypadding;
            this.mc_fullscreen.x = -this.playercontainer.x + this._root.videovolumewidth + this._root.videobuttonsize * 2 + this._root.videobuttonspacing * 4 + this._root.videobuttonborderspacing + this.seekbarwidthfs - this._root.playerx - this._root.gallerypadding;
            ...
            this.playermask.x = loc1 = -this.playercontainer.x - this._root.playerx - this._root.gallerypadding;
            this.video.x = loc1;
            this.playermask.y = loc1 = -this.playercontainer.y - this._root.playery - this._root.gallerypadding - this._root.categoryareaheight;
            this.video.y = loc1;
        ...
        internal function tooltipScrub(arg1:flash.events.Event):void
        {
            if (this.mc_seekbg.hitTestPoint(this._stage.mouseX, this._stage.mouseY, false)) 
            {
                ...
                if (this._root.fsvar) 
                {
                    this.tooltiptxt.text = this.timeFormat(Math.round((this.tooltip.x + this._root.playerx + this.playercontainer.x + this._root.gallerypadding - this._root.videobuttonspacing - this._root.videobuttonborderspacing - this._root.videobuttonsize - 10) / this.mc_seekbg.width * this.videoduration));
                }
                else 
                {
        ...
        {
            this.updatetimer = new flash.utils.Timer(100);
