package gallerylib 
{
    ...
    {
        public function createvideoplayer(arg1:flash.display.Stage, arg2:flash.display.MovieClip, arg3:flash.display.MovieClip, arg4:flash.display.MovieClip, arg5:flash.display.MovieClip, arg6:Object, arg7:String, arg8:String, arg9:Number, arg10:Number, arg11:String, arg12:String, arg13:Number)
        {
            ...
            this.videobg = new flash.display.Sprite();
            ...
            this._root = arg2;
            this._thumb = arg3;
            this._container = arg4;
            this._gallery = arg5;
            this._playerobj = arg6;
            this._videolink = arg7;
            this._previewimagelink = arg8;
            this._widthvar = arg9;
            this._heightvar = arg10;
            this._autoplay = arg11;
            this._loop = arg12;
            this._startvolume = arg13;
            ...
            this.videobg.graphics.beginFill(this._root.solidbackgroundcolor);
            this.videobg.graphics.drawRect(0, 0, 1, 1);
            this.videobg.graphics.endFill();
            this.videobg.alpha = 0;
            this.videobg.mouseEnabled = false;
            this.playercontainer.alpha = 0;
            var loc1:*;
            this.playermask.x = loc1 = Math.round((this._root.gallerywidth - this._root.gallerypadding * 2) / 2) - Math.round(this._root.videoplayerwidth / 2);
            this.playercontainer.x = loc1;
            this.playermask.y = loc1 = Math.round((this._root.thumbheight * this._root.thumbrows + (this._root.thumbrows - 1) * this._root.thumbspacing) / 2) - Math.round(this._root.videoplayerheight / 2);
            this.playercontainer.y = loc1;
            this._container.addChild(this.playercontainer);
            this.playercontainer.addChild(this.videobg);
            ...
            this._container.addChild(this.playermask);
            this.initInterface();
        ...
        internal function initInterface():void
        {
            ...
            this.tformat.font = this._root.videoplayerfont;
            ...
            this.updatetimer = new flash.utils.Timer(8);
        ...
        internal function videoFadeOut():void
        {
            ...
            this.video_t = org.libspark.betweenas3.BetweenAS3.to(this.video, {"alpha":0}, 1, org.libspark.betweenas3.easing.Expo.easeOut);
            this.video_t.play();
            return;
        }
        ...
        internal function videoFadeIn():void
        {
            ...
            this.video_t = org.libspark.betweenas3.BetweenAS3.to(this.video, {"alpha":1}, 1, org.libspark.betweenas3.easing.Expo.easeOut);
            this.video_t.play();
            return;
        }
        ...
        {
            var loc1:*=5;
            this.tooltipformat.font = this._root.videoplayerfont;
            ...
            this.tooltiptxt.embedFonts = false;
        ...
        internal function imageFadeOut():void
        {
            ...
            this.previewimage_t = org.libspark.betweenas3.BetweenAS3.to(this.previewimage, {"alpha":0}, 1, org.libspark.betweenas3.easing.Expo.easeOut);
        ...
        internal function fsOff():void
        {
            ...
            this._gallery.categorywrap.visible = true;
            this._gallery.detailleft_mc.visible = true;
            this._gallery.detailright_mc.visible = true;
            this._thumb.closeiconmc.visible = true;
            ...
            this.playermask.width = this._widthvar;
            this.playermask.height = this._heightvar;
            ...
            this.previewimage.y = this.video.y;
            this.playerShrink();
            this.playermask.x = this.playercontainer.x;
            this.playermask.y = this.playercontainer.y;
            this.videobg.alpha = 0;
            this.tooltip.y = this.interfaceyposup - Math.round(this.tooltipbg.height / 2) - 8;
            this.bigplay.x = Math.round(this._widthvar / 2 - this.bigplay.width / 2);
            this.bigplay.y = Math.round(this._heightvarmod / 2 - this.bigplay.height / 2);
        ...
        internal function fsOn():void
        {
            ...
            this._gallery.categorywrap.visible = false;
            this._gallery.detailleft_mc.visible = false;
            this._gallery.detailright_mc.visible = false;
            this._thumb.closeiconmc.visible = false;
            ...
            this.interfaceypos_fs = this._stage.stageHeight - this.playercontainer.y - this._root.playery - this._root.gallerypadding - this._root.categoryareaheight;
            this.interfaceyposup_fs = this._stage.stageHeight - this.playercontainer.y - this._root.videobuttonsize - this._root.videobuttonbottomspacing - this._root.playery - this._root.gallerypadding - this._root.categoryareaheight;
            this.interfacebgyposup_fs = this._stage.stageHeight - this.playercontainer.y - this._root.videobuttonsize - this._root.videobuttonbottomspacing * 2 - this._root.playery - this._root.gallerypadding - this._root.categoryareaheight;
            this.txt.x = Math.round(this.seekbarwidthfs - this.txt.width) - 10;
            this.mc_play.x = -this.playercontainer.x + this._root.videobuttonborderspacing - this._root.playerx - this._root.gallerypadding;
            this.mc_pause.x = -this.playercontainer.x + this._root.videobuttonborderspacing - this._root.playerx - this._root.gallerypadding;
            this.mc_seek.x = -this.playercontainer.x + this._root.videobuttonsize + this._root.videobuttonspacing + this._root.videobuttonborderspacing - this._root.playerx - this._root.gallerypadding;
            this.mc_volume.x = -this.playercontainer.x + this._root.videobuttonsize + this._root.videobuttonspacing * 2 + this._root.videobuttonborderspacing + this.seekbarwidthfs - this._root.playerx - this._root.gallerypadding;
            this.mc_fullscreen.x = -this.playercontainer.x + this._root.videovolumewidth + this._root.videobuttonsize + this._root.videobuttonspacing * 3 + this._root.videobuttonborderspacing + this.seekbarwidthfs - this._root.playerx - this._root.gallerypadding;
            this.mc_interfacebg.x = -this.playercontainer.x - this._root.playerx - this._root.gallerypadding;
            var loc3:*;
            ...
            this.videobg.x = loc3 = -this.playercontainer.x - this._root.playerx - this._root.gallerypadding;
            this.playermask.x = loc3 = loc3;
            this.video.x = loc3;
            this.videobg.y = loc3 = -this.playercontainer.y - this._root.playery - this._root.gallerypadding - this._root.categoryareaheight;
            this.playermask.y = loc3 = loc3;
            this.video.y = loc3;
            this.videobg.width = loc3 = this._stage.stageWidth + this.playercontainer.x;
            this.playermask.width = loc3;
            this.videobg.height = loc3 = this._stage.stageHeight + this.playercontainer.y;
            this.playermask.height = loc3;
            this.videobg.alpha = 1;
            ...
            if (this._heightvarmod / this._widthvar < loc2) 
            {
                ...
                this.video.width = Math.round(loc1 * this.video.height);
                this.video.y = -this._root.playery - this.playercontainer.y - this._root.gallerypadding - this._root.categoryareaheight;
                this.fsup = -this._root.videobuttonsize - this._root.videobuttonbottomspacing * 2 - this._root.playery - this.playercontainer.y - this._root.gallerypadding - this._root.categoryareaheight;
                this.fsdown = -this._root.playery - this.playercontainer.y - this._root.gallerypadding - this._root.categoryareaheight;
            }
            else 
            {
                this.video.width = this._stage.stageWidth;
                ...
                {
                    this.video.height = Math.round(loc2 * this.video.width) - this._root.videobuttonsize - this._root.videobuttonbottomspacing * 2;
                    this.video.y = Math.round((this._stage.stageHeight - this._root.videobuttonsize - this._root.videobuttonbottomspacing * 2) / 2 - this.video.height / 2) - this._root.playery - this.playercontainer.y - this._root.gallerypadding - this._root.categoryareaheight;
                }
                else 
                {
                    this.video.height = Math.round(loc2 * this.video.width);
                    this.video.y = Math.round(this._stage.stageHeight / 2 - this.video.height / 2) - this._root.playery - this.playercontainer.y - this._root.gallerypadding - this._root.categoryareaheight;
                }
                this.fsup = Math.round(this._stage.stageHeight / 2 - this.video.height / 2) - this._root.videobuttonsize - this._root.videobuttonbottomspacing * 2 - this._root.playery - this.playercontainer.y - this._root.gallerypadding - this._root.categoryareaheight;
                this.fsdown = Math.round(this._stage.stageHeight / 2 - this.video.height / 2) - this._root.playery - this.playercontainer.y - this._root.gallerypadding - this._root.categoryareaheight;
            }
            this.previewimage.width = this.video.width;
            this.previewimage.height = this.video.height;
            this.previewimage.x = this.video.x;
            ...
            this.playerShrink();
            this.tooltip.y = this.interfacebgyposup_fs - Math.round(this.tooltipbg.height / 2) - 8 + this._root.videobuttonbottomspacing;
            this.bigplay.x = Math.round(this._stage.stageWidth / 2 - this.bigplay.width / 2) - this.playercontainer.x - this._root.playerx;
            this.bigplay.y = Math.round(this._stage.stageHeight / 2 - this.bigplay.height / 2) - this.playercontainer.y - this._root.playery;
            return;
        }
        ...
        public function killPlayer():void
        {
            ...
            this._container.removeChild(this.playercontainer);
            this._container.removeChild(this.playermask);
            this._gallery.allowClicks();
            return;
        }
        ...
        internal function tooltipScrub(arg1:flash.events.Event):void
        {
            if (this.mc_seekbg.hitTestPoint(this._stage.mouseX, this._stage.mouseY, false)) 
            {
                this.tooltip.x = this._stage.mouseX - this.playercontainer.x - this._root.gallerypadding - this._root.playerx;
                if (this._root.fsvar) 
                {
                    this.tooltiptxt.text = this.timeFormat(Math.round((this.tooltip.x + this._root.playerx + this.playercontainer.x + this._root.gallerypadding - this._root.videobuttonspacing - this._root.videobuttonborderspacing - this._root.videobuttonsize - 10) / this.mc_seekbg.width * this.metaObj.duration));
                }
                else 
                {
        ...
        internal function imageFadeIn():void
        {
            ...
            this.previewimage_t = org.libspark.betweenas3.BetweenAS3.to(this.previewimage, {"alpha":1}, 1, org.libspark.betweenas3.easing.Expo.easeOut);
            this.previewimage_t.play();
            return;
        }
        ...
        internal var _thumb:flash.display.MovieClip;
        ...
        internal var videobg:flash.display.Sprite;
