package alternatebannerlib 
{
    ...
    public class leftbutton extends flash.display.MovieClip
    {
        public function leftbutton(arg1:flash.display.MovieClip, arg2:flash.display.MovieClip)
        {
            this.btnmc = new flash.display.MovieClip();
            this.btnicon = new banner_left();
            super();
            this._root = arg1;
            this._banner = arg2;
            if (this._root.navigplaypause != "true") 
            {
                this.buttonpos = Math.round(this._root.bannerwidth / 2) - 30 - Math.round(this._root.navigbuttonspacing / 2);
            }
            else 
            {
        ...
        internal function mouse_click(arg1:*):void
        {
            if (this._banner.clickallow && this._banner.clickallow2) 
            {
                ...
                this._banner.loadPreviousSlide();
            }
            return;
        }
