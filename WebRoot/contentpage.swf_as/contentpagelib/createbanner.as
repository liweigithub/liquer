package contentpagelib 
{
    ...
    public class createbanner extends flash.display.MovieClip
    {
        ...
        internal function createNavigDots():void
        {
            ...
            {
                this.navigdots[loc1] = new contentpagelib.navigdot(this._root, this.banner, loc1, this);
                ++loc1;
            }
            if (this._root.playpauseactivated == "true") 
            {
                this.playbtn = new contentpagelib.playbutton(this._root, this);
                this.pausebtn = new contentpagelib.pausebutton(this._root, this);
            }
            return;
        }
        ...
        internal function loadNextImage():void
        {
            ...
            {
                this.images[this.curimage] = new contentpagelib.image(this._root, this.banner, this.curimage, this);
